...
const { getExpenses, graphByMonths, updateExpense, getFixedExpenses, getMonthBalance, searchExpenses } = require('./route')
const app = express()
...
app.get('/getMonthBalance', (req, res, next) => getMonthBalance(req, res, next, db))
app.get('/searchExpenses', (req, res, next) => searchExpenses(req, res, next, db))
